package com.webcrawler.common.controller;
...
import com.webcrawler.validation.ValidationErrors;
...
public abstract class AbstractController {
	...
	/**
	 * The getCrawlerBean() method is used to get CrawlerBean instance.
	 *
	 * @return CrawlerBean object
	 */
	protected CrawlerBean getCrawlerBean() {
		return (CrawlerBean) getControllerObject("crawlerBean", CrawlerBean.class);
	}
